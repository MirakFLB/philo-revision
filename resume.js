/* =====================================================================
   Philosophie — COURS COMPLET RÉDIGÉ par notion. Onglet « Cours ».
   Intro problématisée + I/II/III argumentés (sous-parties A/B/C) +
   transitions + conclusion + à retenir. Plan dialectique : I = thèse 🔵,
   II = antithèse 🔴, III = dépassement 🟣.
   ===================================================================== */
(function () {
  ...
  set("devoir", {
    ...
    parties: [
      ...
      { t: "II. Mais le devoir est peut-être une contrainte intériorisée (🔴)",
        sub: [
          ...
          { t: "B. La pression sociale et la servitude volontaire", p: [
            "Bergson prolonge l'idée au plan social : une grande part de ce que nous appelons « morale » n'est que la pression du groupe sur l'individu, comparable à l'instinct chez l'animal — c'est la « morale close », qui assure la cohésion de la société et qu'on suit sans la penser, « parce que ça se fait ».",
            "La Boétie avait nommé cette obéissance la « servitude volontaire » : l'étonnant n'est pas que les hommes obéissent, mais qu'ils consentent, et finissent par aimer, ce qui les soumet. Le devoir risque alors de n'être qu'un dressage réussi, d'autant plus efficace qu'il se prend pour de la liberté." ] }
        ],
      ...
      { t: "III. Le devoir comme décentrement : un « deux-voir » (🟣)",
        sub: [
          { t: "A. La conscience comme tribunal intérieur (Kant)", p: [
          ...
          { t: "B. Le visage d'autrui et la morale ouverte (Levinas, Bergson)", p: [
            "Levinas va plus loin : ce qui m'oblige réellement, c'est le visage d'autrui, sa fragilité, qui me commande « tu ne tueras point » avant tout contrat. Le devoir naît de la rencontre, non du calcul ; la responsabilité précède la liberté.",
            "Bergson, enfin, montre qu'au-delà de la morale close existe une « morale ouverte », celle des héros et des saints, qui n'impose aucune règle mais entraîne par l'amour : non plus « tu dois », mais « regarde, et suis-moi ». Le devoir le plus haut n'est plus une contrainte subie, c'est une aspiration." ] }
        ] }
    ],
    conclusion: "Le devoir n'est donc ni une simple contrainte sociale ni un pur commandement que je m'adresse à moi seul : il prend sens dans le rapport à ce qui me dépasse — la loi morale, et surtout autrui. C'est pourquoi le plus grand danger n'est pas de désobéir, mais d'obéir sans penser : la « banalité du mal » (Arendt, à propos du procès Eichmann) montre qu'on peut commettre le pire « par devoir », par pure obéissance, faute d'avoir jugé par soi-même. Le vrai devoir exige donc parfois de désobéir, au nom d'une exigence plus haute — il n'est pas l'abdication du jugement, mais son exercice le plus difficile.",
    retenir: [
      "Distinctions : devoir / contrainte / nécessité ; agir PAR devoir / CONFORMÉMENT au devoir ; morale / éthique ; légalité / légitimité.",
      "Citations : impératif catégorique = « universalise ta maxime » (Kant) ; « Tu dois » vs « Je veux » (Nietzsche) ; le Surmoi (Freud).",
  ...
  set("liberte", {
    intro: "Être libre, c'est se déterminer soi-même : la liberté, au sens du libre arbitre, est ce pouvoir de la volonté de choisir sans y être forcée. Elle s'oppose au déterminisme, principe selon lequel tout événement — y compris nos décisions — est l'effet nécessaire de causes antérieures. Or nous avons le sentiment vif de notre liberté : nous délibérons, nous hésitons, nous aurions « pu faire autrement ». Mais ce sentiment prouve-t-il quelque chose ? Peut-être n'est-il qu'une illusion née de l'ignorance des causes qui nous font agir. Tout le problème est là : je SENS que je suis libre, mais puis-je le SAVOIR, en faire l'expérience certaine — et que serait, au juste, une liberté véritable ?",
    parties: [
      { t: "I. Oui, je fais l'expérience de ma liberté (🔵)",
        sub: [
          { t: "A. La liberté révélée par le doute (Descartes)", p: [
            "Descartes fait du libre arbitre la marque de l'homme, ce qui le rapproche de Dieu. Le doute volontaire le prouve : je peux suspendre mon jugement, refuser mon assentiment, même à ce qui semble évident. Ma volonté est sans limites — « infinie ».",
            "Toutefois, la liberté n'est pas l'indifférence : choisir à pile ou face, sans raison, est le plus bas degré de la liberté. Elle est au contraire à son sommet quand, voyant clairement le vrai et le bien, je m'y porte sans hésiter : bien voir pour bien choisir. Être libre, ce n'est donc pas tergiverser, c'est adhérer en connaissance de cause." ] },
          { t: "B. La liberté comme condition et comme projet (stoïciens, Sartre)", p: [
            "Les stoïciens (Épictète) enseignent à distinguer ce qui dépend de nous (nos jugements, nos désirs) de ce qui n'en dépend pas (les événements, le corps, la réputation) : la liberté intérieure consiste à ne vouloir que le premier, ce qui procure l'ataraxie. On n'est jamais esclave que de ses propres représentations.",
      ...
      { t: "II. Mais cette liberté est peut-être une illusion (🔴)",
        sub: [
          ...
          { t: "B. Les déterminismes (Rousseau, Marx, Freud)", p: [
            "Les sciences humaines confirment ce soupçon : Marx montre les déterminismes socio-économiques (nos idées dépendent de notre classe), Freud l'inconscient (le Moi « n'est pas maître dans sa propre maison »), Bourdieu l'habitus. Rousseau résume la condition politique : « l'homme est né libre, et partout il est dans les fers »." ] },
          { t: "C. La liberté, inconnaissable (Kant)", p: [
            "Kant tire la leçon décisive : la liberté n'est pas un objet d'expérience, car toute expérience suppose la causalité, alors que la liberté est spontanéité, commencement absolu. On ne peut donc pas la connaître ; elle reste une « idée transcendantale » que la raison pense sans jamais la prouver. La science ne rencontrera jamais la liberté, mais elle ne pourra jamais non plus la réfuter." ] }
        ],
      ...
      { t: "III. La liberté véritable se conquiert dans la limite (🟣)",
        sub: [
          { t: "A. La contrainte qui libère (Stravinsky, Spinoza)", p: [
            "Loin de s'opposer à la contrainte, la liberté la suppose. Stravinsky le dit de la création : « ma liberté est d'autant plus grande que je limite mon champ d'action » — c'est la règle, la contrainte de la forme, qui rend l'œuvre libre possible ; sans elle, le caprice, pas la liberté.",
            "De même Spinoza : connaître ses déterminismes, c'est cesser de les subir passivement pour commencer à agir — passer de la passion à l'action. La liberté n'est pas l'absence de cause, mais la connaissance de ses causes." ] },
          { t: "B. La liberté révélée par l'obligation (Kant, Levinas)", p: [
            "Plus encore, c'est l'expérience de l'obligation qui me révèle libre. Kant : si je me sens tenu par le « tu dois », c'est que je me sais capable d'y obéir — « tu dois, donc tu peux ». La loi morale, loin d'abolir la liberté, en est la preuve (« ratio cognoscendi »). Levinas : le visage d'autrui m'oblige, et cette obligation me constitue comme sujet libre et responsable.",
            "Être libre, ce n'est donc pas l'absence de contrainte, mais le rapport lucide et choisi à elle." ] }
        ] }
    ],
  ...
  set("bonheur", {
    ...
    parties: [
      { t: "I. Le bonheur s'atteint par la sagesse et la maîtrise des désirs (🔵)",
        sub: [
          ...
          { t: "B. Changer ses désirs plutôt que le monde (Descartes, Spinoza)", p: [
            ...
            "Spinoza opère un renversement célèbre : on ne réprime pas ses passions parce qu'on serait heureux par devoir, mais on devient capable de les maîtriser PARCE QU'on éprouve déjà une joie supérieure — la béatitude, cet « amour intellectuel de Dieu » qu'est la connaissance. La vertu ne précède pas le bonheur : elle en découle." ] }
        ],
        trans: "Mais cette sagesse qui prêche la modération n'est-elle pas une façon de se résigner, voire de mutiler la vie ? Le bonheur n'est-il pas, au contraire, dans l'intensité et la satisfaction de tous nos désirs ?" },
      { t: "II. Mais le bonheur comme satisfaction est un piège (🔴)",
        sub: [
          { t: "A. Tout désirer, ou le tonneau percé (Calliclès / Socrate)", p: [
            "Calliclès, dans le Gorgias, défend la thèse inverse : la vie heureuse, c'est l'intempérance, le fait de laisser ses désirs « grossir autant que possible » et de pouvoir les satisfaire. La maîtrise de soi serait une morale d'impuissants.",
            "Socrate lui oppose l'image du tonneau percé : l'homme aux désirs sans mesure passe sa vie à remplir un récipient troué ; loin d'être comblé, il est au supplice. Le désir illimité ne mène pas au bonheur mais à l'inquiétude perpétuelle." ] },
      ...
      { t: "III. Renoncer à « faire » son bonheur (🟣)",
        sub: [
          { t: "A. Le bonheur, idéal indéterminé (Kant)", p: [
            "Kant refuse de faire du bonheur le fondement de la morale, car c'est un « idéal de l'imagination », non de la raison : indéterminé, il varie d'un homme à l'autre, et le programmer sûrement exigerait une omniscience que nous n'avons pas. Mieux vaut donc ne pas chercher à être heureux, mais à se rendre DIGNE de l'être, en agissant par devoir. C'est aussi pourquoi le bonheur n'est pas l'affaire de l'État : un pouvoir prétendant imposer le bonheur de ses sujets serait « le pire despotisme »." ] },
          { t: "B. L'insatisfaction vivifiante (Rousseau, Proust)", p: [
            "Rousseau ajoute une nuance décisive : « malheur à qui n'a plus rien à désirer ». L'insatisfaction du désir n'est pas seulement une souffrance, c'est ce qui maintient la vie vivante et ouverte ; un désir comblé pour toujours serait la mort.",
            "Peut-être, alors, le bonheur ne se cherche-t-il pas de front : il survient « par surcroît », à l'improviste (Proust et la mémoire involontaire), quand on cesse de le poursuivre." ] }
        ] }
    ],
    ...
    parties: [
      { t: "I. Il existe une norme objective du juste (🔵)",
        sub: [
          { t: "A. Une justice fondée en raison ou en nature", p: [
            ...
            "Dans tous les cas, la justice n'est pas affaire de force ou de goût : elle a un fondement que la raison ou la conscience peuvent reconnaître, et au nom duquel on peut juger les lois elles-mêmes (légitimité contre simple légalité)." ] },
          { t: "B. Les trois formes de justice (Aristote)", p: [
            "Aristote distingue la justice commutative (l'égalité arithmétique dans les échanges : un prix juste, une réparation exacte), la justice distributive (la répartition des biens et des honneurs selon le mérite de chacun, donc proportionnelle, non identique pour tous) et la justice corrective ou pénale (rétablir l'équilibre rompu par une faute).",
            "Être juste, ce n'est donc pas toujours traiter tout le monde de la même façon : l'égalité géométrique (« à chacun selon son mérite ») peut être plus juste que l'égalité arithmétique." ] }
        ],
      ...
      { t: "II. Mais le juste n'est peut-être qu'une convention et un rapport de force (🔴)",
        sub: [
          ...
          { t: "B. Le triomphe de la force (Pascal, Calliclès)", p: [
            "Pascal pousse le constat : « ne pouvant faire que ce qui est juste fût fort, on a fait que ce qui est fort fût juste ». Faute de pouvoir imposer le juste, les hommes ont décrété juste ce qui s'impose par la force. Et il ajoute, ironique : « vérité au-deçà des Pyrénées, erreur au-delà » — ce qui est tenu pour juste d'un côté de la frontière est crime de l'autre.",
            "Calliclès, déjà, identifiait la justice « selon la nature » au droit du plus fort. Réduit à cela, le mot « justice » ne serait qu'un voile posé sur les rapports de domination." ] }
        ],
      ...
      { t: "III. Rendre les conventions justes : l'équité (🟣)",
        sub: [
          { t: "A. L'équité, correctif de la loi (Aristote)", p: [
          ...
          { t: "B. La justice comme équité (Rawls, Montesquieu)", p: [
            "Rawls propose une procédure pour fonder des principes vraiment justes : derrière un « voile d'ignorance » où chacun ignorerait sa future place sociale (riche ou pauvre, doué ou non), des individus rationnels choisiraient des règles équitables — dont le « principe de différence » : les inégalités ne sont justes que si elles profitent aussi aux plus défavorisés.",
            "Montesquieu, lui, montre que sans séparation des pouvoirs, aucune justice n'est garantie contre l'arbitraire : la justice n'est pas qu'un principe, c'est aussi une affaire d'institutions." ] }
        ] }
    ],
  ...
  set("langage", {
    ...
    parties: [
      { t: "I. Le langage n'est pas un simple outil : il est lié à la pensée (🔵)",
        sub: [
          { t: "A. On pense dans les mots (Hegel, Saussure)", p: [
            "Hegel renverse l'idée commune : « c'est dans les mots que nous pensons ». Ce que nous croyons « ineffable » — un sentiment trop profond pour être dit — n'est souvent que de la pensée encore confuse, qui n'a pas trouvé ses mots. Loin de trahir la pensée, le mot l'achève et la fixe.",
            "Saussure le confirme : sans la langue, la pensée n'est qu'une « masse amorphe », un nuage indistinct ; c'est le système des signes (signifiant / signifié) qui la découpe et lui donne forme. Le signe est arbitraire (aucun lien naturel entre le mot et la chose), mais c'est lui qui structure notre vision du monde." ] },
          { t: "B. Le langage, propre de l'homme (Benveniste, Descartes)", p: [
            "Le langage humain n'est pas un simple code de signaux comme la « danse » des abeilles : celle-ci est fermée, fixe, limitée à un contenu (la source de nourriture) et ne se transmet pas. Le langage humain, lui, est créatif (on forme des phrases inédites), il permet le dialogue, il porte sur l'absent et l'abstrait (Benveniste).",
            "Pour Descartes déjà, c'est la capacité de « répondre à propos », et non de répéter mécaniquement, qui distingue l'homme de l'animal-machine — et aujourd'hui, de l'intelligence artificielle." ] }
        ],
      ...
      { t: "II. Mais le langage est un outil réducteur et un pouvoir (🔴)",
        sub: [
          ...
          { t: "B. Le langage comme rapport de pouvoir (Barthes, Bourdieu)", p: [
            "Le langage n'est pas neutre. Barthes provoque : « la langue est fasciste » — non parce qu'elle interdirait de parler, mais parce qu'elle OBLIGE à dire selon ses catégories (genres, temps, hiérarchies).",
            "Bourdieu montre que la « langue légitime » est un capital inégalement réparti : la maîtrise du « bien parler » reproduit les rapports de classe et confère une autorité. Parler, c'est aussi exercer ou subir un pouvoir — de la rhétorique antique aux « éléments de langage » contemporains." ] }
        ],
      ...
      { t: "III. Le langage nous relie, jusque dans ses défaillances (🟣)",
        sub: [
          { t: "A. Le ratage qui parle (Freud)", p: [
            "Freud montre que même le langage qui « rate » dit quelque chose : le lapsus, l'acte manqué, trahissent un désir inconscient ; la défaillance est elle-même parlante et révèle un fond commun à tous les humains. Le sens déborde toujours l'intention." ] },
          { t: "B. La parole comme reconnaissance (Levinas, Ricœur)", p: [
            "Levinas souligne que le simple fait d'adresser la parole à autrui « institue le rapport moral d'égalité » : avant tout contenu, parler, c'est reconnaître l'autre comme interlocuteur. Ricœur ajoute que traduire, malgré l'impossibilité d'une équivalence parfaite, est une « hospitalité langagière » : on accueille la langue de l'autre chez soi.",
            "Communiquer n'est donc pas mécaniquement « mettre en commun » des informations, comme le ferait une machine : c'est, à travers l'effort et le malentendu surmonté, faire surgir un sens partagé." ] }
        ] }
    ],
  ...
  set("etat", {
    ...
    parties: [
      { t: "I. L'État libère et réalise la liberté (🔵)",
        sub: [
          { t: "A. L'homme ne se réalise que dans la cité (Aristote)", p: [
            "Pour Aristote, l'homme est un « animal politique » (zoon politikon) : il ne se réalise pleinement que dans la cité, qui lui permet d'accéder au langage, à la justice et à la vie bonne. Hors de la cité, dit-il, on est « ou une bête, ou un dieu » : l'État n'est pas une contrainte ajoutée à l'homme, c'est sa condition d'accomplissement." ] },
          { t: "B. L'État, réalité de la liberté (Hegel, Spinoza)", p: [
            "Hegel va jusqu'à voir dans l'État « la réalité de la liberté » : en s'élevant au-dessus des intérêts particuliers, l'État incarne l'universel et permet à la liberté individuelle de devenir effective, et non plus abstraite.",
            "Spinoza, plus sobrement, affirme que « le but de l'État, c'est la liberté » : il existe pour que les hommes vivent en sécurité et puissent penser et s'exprimer librement." ] }
        ],
        trans: "Mais cet État qui se dit au service de la liberté n'est-il pas, en réalité, l'instrument d'une domination ?" },
      { t: "II. L'État opprime et domine (🔴)",
        sub: [
          { t: "A. L'État, instrument de classe (Marx, anarchistes)", p: [
          ...
          { t: "B. Le monstre froid et la surveillance (Nietzsche, Foucault)", p: [
      ...
      { t: "III. Le contrat et la séparation des pouvoirs (🟣)",
        sub: [
          { t: "A. Le contrat social (Hobbes, Rousseau)", p: [
            "Les théoriciens du contrat montrent que l'État, même contraignant, peut être légitime s'il résulte d'un accord. Hobbes part de l'état de nature, « guerre de tous contre tous » où « l'homme est un loup pour l'homme » : par peur de la mort violente, les individus renoncent à leur force au profit d'un souverain absolu, le Léviathan, qui garantit la paix.",
            "Rousseau corrige : le contrat social ne doit pas aliéner la liberté mais la fonder — en obéissant à la « volonté générale », le citoyen n'obéit qu'à lui-même." ] },
          { t: "B. Limiter le pouvoir (Montesquieu)", p: [
            "Reste à empêcher l'État de dégénérer en despotisme. C'est l'apport de Montesquieu : « il faut que, par la disposition des choses, le pouvoir arrête le pouvoir » — d'où la séparation des pouvoirs exécutif, législatif et judiciaire. Un État légitime n'est pas un État faible, mais un État limité, soumis au droit qu'il édicte." ] }
        ] }
    ],
  ...
  set("nature", {
    ...
    parties: [
      { t: "I. La nature est un ordre finalisé, voire divin (🔵)",
        sub: [
          { t: "A. Un cosmos finalisé (Aristote, stoïciens)", p: [
            "Pour Aristote, « la nature ne fait rien en vain » : chaque être tend vers une fin (telos) inscrite en lui — le gland vers le chêne, l'œil vers la vision. La nature est un cosmos, un tout ordonné et harmonieux.",
            "Les stoïciens en tirent une morale : puisque la nature est régie par une raison universelle (le Logos), la sagesse consiste à « vivre selon la nature », c'est-à-dire à accorder sa propre raison à l'ordre du monde, et à accepter ce qui ne dépend pas de nous." ] },
          { t: "B. Dieu, c'est-à-dire la Nature (Spinoza)", p: [
            "Spinoza identifie Dieu et la nature : « Deus sive Natura ». La nature n'est pas une création extérieure à Dieu, elle est Dieu même, substance infinie et nécessaire (on distingue la natura naturans, créatrice, et la natura naturata, créée). La comprendre par la raison, c'est accéder à la béatitude." ] }
        ],
      ...
      { t: "II. La nature est une matière sans finalité, offerte à la maîtrise (🔴)",
        sub: [
          { t: "A. Une matière sans dessein (Lucrèce, Épicure)", p: [
          ...
          { t: "B. Maître et possesseur de la nature (Descartes)", p: [
      ...
      { t: "III. Dépasser le partage nature / culture (🟣)",
        sub: [
          { t: "A. Une frontière mouvante (Lévi-Strauss, Descola)", p: [
            "Lévi-Strauss observe que l'universel relève de la nature et la règle de la culture ; mais la prohibition de l'inceste, à la fois universelle et instituée, brouille la frontière. Descola, dans Par-delà nature et culture, montre que ce grand partage — l'homme d'un côté, la nature de l'autre — est une particularité de l'Occident moderne, et non une évidence universelle." ] },
          { t: "B. La portée écologique", p: [
            "Cette remise en cause a une portée écologique majeure : si l'homme n'est pas hors de la nature mais en fait partie, la dominer revient à se détruire soi-même. D'où l'idée d'une responsabilité envers le vivant et les générations futures (Jonas), et le biomimétisme, qui ne cherche plus à soumettre la nature mais à s'en inspirer." ] }
        ] }
    ],
  ...
  set("conscience", {
    ...
    parties: [
      { t: "I. La conscience fonde le sujet et la connaissance (🔵)",
        sub: [
          { t: "A. Le cogito, première certitude (Descartes)", p: [
          ...
          { t: "B. Sujet et intentionnalité (Kant, Husserl)", p: [
            "Kant montre que cette conscience est la condition de toute expérience : « le “je pense” doit pouvoir accompagner toutes mes représentations » — sans l'unité d'un sujet, mes perceptions seraient un chaos sans lien.",
            "Husserl, enfin, dégage l'intentionnalité : « toute conscience est conscience de quelque chose » — elle n'est jamais vide, toujours tournée vers un objet, ouverte sur le monde." ] }
        ],
      ...
      { t: "II. La conscience est seconde, déterminée et trompée (🔴)",
        sub: [
          { t: "A. La vie détermine la conscience (Marx, Spinoza)", p: [
            ...
            "Spinoza l'avait dit : nous sommes conscients de nos actes, mais ignorants des causes qui les déterminent — d'où l'illusion du libre arbitre." ] },
          { t: "B. Le Moi décentré (Freud, Hume)", p: [
            "Freud porte le coup décisif : le Moi « n'est pas maître dans sa propre maison », gouverné en partie par l'inconscient. La conscience n'est que la pointe émergée de l'iceberg psychique.",
            "Hume, enfin, va jusqu'à nier un « moi » substantiel : en m'observant, je ne trouve qu'un flux de perceptions, un « théâtre » sans acteur permanent. L'identité personnelle serait une fiction commode." ] }
        ] }
    ],
  ...
  set("inconscient", {
    ...
    parties: [
      { t: "I. L'inconscient existe et explique nos conduites (🔴 — la thèse freudienne)",
        sub: [
          { t: "A. Des faits qui exigent une explication", p: [
            "Freud part de faits que la conscience ne peut expliquer : rêves, lapsus, actes manqués, symptômes névrotiques. Tous ont un sens, mais un sens caché : ils sont la réalisation déguisée de désirs refoulés. Le rêve est la « voie royale qui mène à l'inconscient » ; le lapsus, loin d'être un hasard, trahit ce que je ne voulais pas dire. L'hypothèse permet ainsi d'unifier et de soigner ce qui paraissait absurde." ] },
          { t: "B. Une longue tradition (Leibniz, Jung)", p: [
            "« Le Moi n'est pas maître dans sa propre maison » : c'est la « troisième blessure narcissique » infligée à l'humanité, après Copernic et Darwin. Leibniz l'avait pressentie avec ses « petites perceptions » (trop faibles pour être conscientes mais qui agissent) ; Jung l'élargira à un « inconscient collectif », fait d'archétypes communs à l'humanité." ] }
        ],
        trans: "Mais accepter l'inconscient, n'est-ce pas se donner une excuse commode pour tout ce que l'on n'assume pas ?" },
      { t: "II. L'inconscient, une illusion qui déresponsabilise (🔵 — la critique)",
        sub: [
          { t: "A. La mauvaise foi (Sartre, Alain)", p: [
          ...
          { t: "B. Une théorie irréfutable (Popper)", p: [
  ...
  set("temps", {
    ...
    parties: [
      { t: "I. Le temps est une forme de l'esprit, pas une chose (🔵)",
        sub: [
          { t: "A. Le temps n'est que dans l'âme (Augustin)", p: [
          ...
          { t: "B. Forme a priori et durée (Kant, Bergson)", p: [
            "Kant systématise : le temps est une « forme a priori de la sensibilité ». Il n'est pas une chose que l'on percevrait, mais la condition subjective sous laquelle nous percevons tout — la structure même de notre expérience.",
            "Bergson, enfin, oppose au temps spatialisé des horloges la « durée » : un flux qualitatif, continu et indivisible. La mesurer, c'est déjà la trahir en la découpant comme de l'espace : une heure d'attente et une heure de plaisir n'ont pas la même durée vécue." ] }
        ],
        trans: "Mais réduire le temps à l'esprit, n'est-ce pas oublier qu'il s'écoule, lui, que nous y pensions ou non ?" },
      { t: "II. Le temps est une réalité objective du monde (🔴)",
        sub: [
          { t: "A. Le devenir universel (Héraclite, Galilée)", p: [
            "Héraclite affirme que le devenir est la réalité même : « on ne se baigne jamais deux fois dans le même fleuve », car l'eau, et nous-mêmes, avons changé. Tout coule (panta rhei) ; la permanence est l'illusion. La science, depuis Galilée, fait du temps une grandeur mesurable, paramètre des lois de la nature, indépendant de toute conscience." ] },
          { t: "B. L'épreuve de l'éternel retour (Nietzsche)", p: [
            "Nietzsche tire du temps une épreuve éthique, l'« éternel retour » : imagine qu'il te faille revivre ta vie exactement à l'identique, une infinité de fois. La supporterais-tu ? Mieux : la voudrais-tu ? Dire « oui » à cette pensée, c'est l'amor fati — aimer son destin au point de vouloir son retour éternel. Le temps n'est plus alors un fardeau, mais l'épreuve de notre rapport à la vie." ] }
        ] }
    ],
  ...
  set("art", {
    ...
    parties: [
      { t: "I. L'art comme imitation (🔵)",
        sub: [
          { t: "A. L'imitation d'imitation (Platon)", p: [
          ...
          { t: "B. L'expression sensible de l'Idée (Hegel)", p: [
            "Hegel renverse la hiérarchie sans abandonner l'idée d'imitation : l'art est « l'expression sensible de l'Idée ». Parce qu'il donne forme à l'esprit dans la matière, le beau artistique est supérieur au beau naturel : une statue ou un portrait dit plus de l'homme qu'un corps réel, car il en exprime l'intériorité." ] }
        ],
        trans: "Mais réduire l'art à l'imitation, n'est-ce pas manquer ce qui fait sa puissance : sa capacité à créer du neuf ?" },
      { t: "II. L'art comme création (🔴)",
        sub: [
          { t: "A. Le beau sans concept et le génie (Kant)", p: [
          ...
          { t: "B. Rendre visible (Nietzsche, Klee)", p: [
            "Nietzsche fait de l'art une nécessité vitale : « nous avons l'art pour ne pas mourir de la vérité » — il rend supportable une existence sans fondement. Klee résume la modernité : « l'art ne reproduit pas le visible, il rend visible » — il dévoile ce que l'œil ordinaire ne voit pas, plutôt que de copier ce qui est déjà là." ] }
        ],
        trans: "Imitation ou création : faut-il choisir ? L'art ne tient-il pas justement dans la tension entre les deux ?" },
      { t: "III. Imiter pour transformer et révéler (🟣)",
        sub: [
          { t: "A. Mimésis et catharsis (Aristote)", p: [
            "Aristote réhabilite la mimésis : imiter n'est pas copier servilement, mais re-présenter, et l'on prend plaisir à reconnaître. Surtout, la tragédie opère une catharsis : en représentant des passions terribles (pitié, crainte), elle les purge chez le spectateur. L'imitation devient transformation morale." ] },
          { t: "B. Sublimation et institution (Freud, Duchamp)", p: [
  ...
  set("travail", {
    ...
    parties: [
      { t: "I. Le travail humanise et libère (🔵)",
        sub: [
          { t: "A. Le travail forme (Hegel)", p: [
            "Hegel, dans la dialectique du maître et de l'esclave, montre le pouvoir formateur du travail. Le maître, qui jouit sans travailler, reste dépendant et stérile ; l'esclave, qui travaille, doit « réfréner son désir » et façonner la matière. Or, en transformant le monde, il s'y reconnaît et accède à la conscience de soi : « le travail forme ». C'est finalement l'esclave, par le travail, qui s'élève à la liberté et à la culture." ] },
          { t: "B. Bâtir un monde commun (Arendt)", p: [
            "Arendt prolonge : par l'œuvre — l'objet durable, l'outil, la maison, l'œuvre d'art —, l'homme bâtit un monde stable qui lui survit et qu'il partage avec autrui. Le travail, au-delà de la survie, donne ainsi à l'existence un sens et une permanence." ] }
        ],
      ...
      { t: "II. Le travail aliène (🔴)",
        sub: [
          { t: "A. L'aliénation du travailleur (Marx)", p: [
          ...
          { t: "B. Une activité indigne de l'homme libre (Aristote, Rousseau)", p: [
            "Cette défiance est ancienne : pour Aristote, le travail manuel, qui asservit aux besoins, est indigne du citoyen libre, qui doit consacrer son temps à la politique et à la contemplation. Rousseau ira jusqu'à dire que « la première passion de l'homme » est l'oisiveté — le travail serait une nécessité, non une vocation." ] }
        ],
        trans: "Faut-il alors condamner le travail en soi, ou seulement une certaine organisation du travail ?" },
      { t: "III. Choisir et transformer son travail (🟣)",
        sub: [
          { t: "A. Le travail repris en main (Sartre)", p: [
          ...
          { t: "B. L'enjeu de la reconnaissance", p: [
  ...
  set("technique", {
    ...
    parties: [
      { t: "I. La technique, instrument de la maîtrise et de la liberté (🔵)",
        sub: [
          { t: "A. Homo faber (Bergson)", p: [
            "Bergson définit l'intelligence par la fabrication : elle est la faculté de « faire des outils à faire des outils ». La technique n'est donc pas un accident, c'est le propre de l'homme, ce qui le distingue de l'animal limité à son instinct et à son corps." ] },
          { t: "B. Se libérer du besoin (Descartes)", p: [
      ...
      { t: "II. La technique, puissance autonome qui menace (🔴)",
        sub: [
          { t: "A. Le système technicien (Ellul)", p: [
          ...
          { t: "B. L'arraisonnement et la responsabilité (Heidegger, Jonas)", p: [
            "Heidegger y voit un rapport au monde : l'« arraisonnement » (Gestell) réduit la nature à un simple stock disponible, sommé de se livrer. Et « la science ne pense pas » : elle calcule sans interroger le sens de l'être.",
            "Jonas, enfin, alerte : devant un pouvoir capable de détruire l'humanité future, il faut un « principe responsabilité » — agir de telle sorte que la vie humaine reste possible sur Terre." ] }
        ],
  ...
  set("religion", {
    ...
    parties: [
      { t: "I. La religion comme illusion et aliénation (🔴)",
        sub: [
          { t: "A. L'opium du peuple (Marx)", p: [
            "Marx donne la formule célèbre : « la religion est l'opium du peuple ». Comme une drogue, elle apaise une souffrance réelle (la misère sociale) — mais en la consolant par l'au-delà, elle détourne d'agir pour transformer les conditions qui la causent. La critique de la religion est donc, pour Marx, le début de toute critique sociale." ] },
          { t: "B. Projection et illusion (Feuerbach, Freud, Nietzsche)", p: [
            "Feuerbach renverse le rapport : ce n'est pas Dieu qui crée l'homme, c'est l'homme qui projette en Dieu ses propres qualités idéalisées (la bonté, la puissance, le savoir infinis). La théologie n'est qu'une anthropologie inversée, et l'homme s'appauvrit de tout ce qu'il prête à son idole.",
            "Freud y voit une illusion née du désir d'un père protecteur, une « névrose obsessionnelle » de l'humanité ; Nietzsche annonce que « Dieu est mort », et avec lui s'effondrent les valeurs suprêmes." ] }
        ],
      ...
      { t: "II. La religion comme lien social et source de sens (🔵 / 🟣)",
        sub: [
          { t: "A. La fonction sociale (Durkheim)", p: [
            "Durkheim, sociologue, met la question de la vérité entre parenthèses pour étudier la fonction de la religion : elle est « une chose éminemment sociale ». Par ses rites collectifs, elle crée et renforce la cohésion du groupe ; en adorant le sacré, la société s'adore en réalité elle-même. La religion relie (religare) avant de faire croire. Aron parlera de « religions séculières » à propos des totalitarismes : preuve que le besoin de sacré demeure même sans Dieu." ] },
          { t: "B. L'élan et le pari (Bergson, Pascal)", p: [
            "Bergson distingue une religion « statique » (la peur, l'habitude, qui ferme le groupe) et une religion « dynamique », élan d'amour ouvert à toute l'humanité (celle des mystiques). Pascal, par le « pari », montre qu'il peut être rationnel de croire : l'enjeu (le salut éternel) étant infini, le calcul penche pour la foi." ] }
        ] }
    ],
    conclusion: "La religion ne se laisse pas réduire à une simple erreur : qu'on la tienne pour vraie ou pour illusoire, elle répond à des besoins profonds — donner sens à la finitude, relier les hommes, fonder une morale commune. La critique (Marx, Freud, Nietzsche) en dénonce les dangers d'aliénation ; la sociologie (Durkheim) en éclaire la fonction. Reste une question que ni l'une ni l'autre ne tranchent : celle de sa vérité, qui relève de la foi, non du savoir.",
    retenir: [
  ...
  set("science", {
    ...
    parties: [
      { t: "I. La science atteint un savoir certain (🔵)",
        sub: [
          { t: "A. La méthode et l'évidence (Descartes)", p: [
          ...
          { t: "B. Le positivisme (Comte)", p: [
            "Comte systématise avec la « loi des trois états » : l'esprit humain passe du stade théologique au métaphysique, puis au stade « positif » où, renonçant à chercher les causes premières (le « pourquoi »), il établit des lois constantes entre les phénomènes (le « comment »). La science y est le modèle même du savoir vrai et le moteur du progrès." ] }
        ],
      ...
      { t: "II. La science est faillible et construite (🔴)",
        sub: [
          { t: "A. Des théories qui se réfutent", p: [
          ...
          { t: "B. Une science construite (Latour, Heidegger)", p: [
      ...
      { t: "III. Ce qui fait la scientificité : l'épistémologie (🟣)",
        sub: [
          { t: "A. La falsifiabilité (Popper)", p: [
          ...
          { t: "B. L'obstacle épistémologique (Bachelard, Claude Bernard)", p: [
  ...
  set("verite", {
    intro: "La vérité qualifie un jugement, une pensée ou un discours qui s'accorde avec son objet : sa définition classique est l'« adéquation de la chose et de l'intellect » (Thomas d'Aquin). On la distingue de la réalité (qui qualifie les choses, non les jugements) et de la certitude (un état subjectif, qui peut être trompeur — on peut être certain et se tromper). On peut aussi définir le vrai par la cohérence interne (en mathématiques) ou par l'accord intersubjectif. Le problème est celui de son statut : la vérité est-elle une, objective et absolue, valable pour tous, ou bien n'est-elle qu'une perspective parmi d'autres, relative à chacun, voire une illusion utile ?",
    parties: [
      { t: "I. La vérité est objective et absolue (🔵)",
        sub: [
          { t: "A. Le monde des Idées (Platon)", p: [
            "Platon distingue le sensible, changeant et trompeur (les « ombres » de la caverne), et l'intelligible, le monde des Idées éternelles et universelles, seul vraiment réel et connaissable. La vérité n'est donc pas affaire d'opinion (doxa) mais de science (épistémè) : elle est une, et la même pour tous." ] },
          { t: "B. L'évidence et sa propre norme (Descartes, Spinoza)", p: [
            "Descartes en cherche le critère et le trouve dans l'évidence : est vrai ce qui se présente à l'esprit de façon si claire et distincte qu'on ne peut en douter (à commencer par le cogito).",
            "Spinoza ajoute que « le vrai est sa propre norme et celle du faux » : une idée vraie porte en elle-même la marque de sa vérité, comme la lumière se montre elle-même et montre l'ombre." ] }
        ],
      ...
      { t: "II. La vérité est relative, voire une illusion (🔴)",
        sub: [
          { t: "A. L'homme mesure de tout (Protagoras)", p: [
            "Protagoras le sophiste affirme : « l'homme est la mesure de toute chose » — il n'y a pas de vérité en soi, seulement ce qui paraît vrai à chacun. Ce relativisme dissout l'idée d'une vérité commune et fait de tout débat une affaire de persuasion." ] },
          { t: "B. Perspectivisme et pragmatisme (Nietzsche, James)", p: [
            "Nietzsche radicalise : « les vérités sont des illusions dont on a oublié qu'elles le sont ». Il n'y a pas de faits, seulement des interprétations ; ce que nous appelons « vérités » ne sont que des fictions utiles à la vie, fixées par habitude.",
            "Le pragmatisme de James va dans le même sens : est vrai ce qui « réussit », ce qui est avantageux pour la pensée et l'action — mais confondre le vrai et l'utile est précisément le piège à éviter." ] }
        ] }
    ],
    conclusion: "Réduire la vérité à une simple opinion personnelle se contredit (affirmer « tout est relatif » comme une vérité absolue) et rend impossibles la science et le dialogue. Mais en faire une évidence intemporelle ignore l'histoire des erreurs humaines. La vérité apparaît alors moins comme une possession que comme une exigence et une conquête : non un point de départ acquis, mais l'horizon d'une recherche commune, qui suppose la discussion, la preuve et la rectification de nos erreurs.",
    retenir: [
  ...
  set("raison", {
    ...
    parties: [
      { t: "I. La raison saisit le réel et le fonde (🔵)",
        sub: [
          { t: "A. Le rationnel et le réel (Hegel, Leibniz)", p: [
          ...
          { t: "B. La raison législatrice et ses limites (Kant)", p: [
            "Kant accorde à la raison un rôle législateur : elle donne ses lois à la connaissance (la nature) et à la morale (le devoir). Mais il marque déjà une limite décisive : la raison s'égare en illusions dès qu'elle prétend connaître au-delà de l'expérience possible (Dieu, l'âme, le monde comme totalité) — c'est l'objet de la métaphysique, où elle se perd dans des contradictions." ] }
        ],
      ...
      { t: "II. La raison est limitée et au service des passions (🔴)",
        sub: [
          { t: "A. L'esclave des passions (Hume)", p: [
          ...
          { t: "B. Le cœur et ses raisons (Pascal, Spinoza)", p: [
